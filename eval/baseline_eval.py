...
print("Qwen3-VL-8B on DGX Spark (GB10)")
print("=" * 70)
...
# 1학기 비교
print("\n[1학기 비교]")
print(f"{'지표':<25s} {'1학기 Qwen2-VL':<20s} {'4-1 Qwen3-VL':<20s}")
print(f"{'-'*70}")
...
# 결과 저장
with open("/home/devlofi/HyeWon/baseline_results.json", "w", encoding="utf-8") as f:
    json.dump({
...
print(f"\n✓ 결과 저장: /home/devlofi/HyeWon/baseline_results.json")
